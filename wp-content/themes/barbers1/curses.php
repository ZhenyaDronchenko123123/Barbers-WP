...
<head>
    <title><?php bloginfo('Академияbarbers'); ?><?php wp_title('|Курсы барберов|Курсы парикмахеров'); ?></title>
	...
	<meta name="Keywords" content="Barbers,barbers курсы,курсы, барберс,парикмахерская,парикмахерские курсы"> 
    ...
    <body>
        <section class="header">
            <img class="bg-courses" src="<? echo get_template_directory_uri()?>/img/courses.jpg" alt="">
            <div class="wrapper">
                <div class="content-courses">
                    <div class="top-content">
                    <div class="dropdown">
                            <button class="dropbtn">Academy &nbsp;<svg width="20" height="10" version="1.1" id="Layer_1"
                            ...
                            <div class="dropdown-content">
                                <a href="<?=get_site_url(null, 'vitebsk')?>">Витебск</a>
                                <a href="<?=get_site_url(null, 'mogilev')?>">Могилев</a>
                                <a href="<?=get_site_url(null, 'gomel')?>">Гомель</a>
                            </div>
                        </div>
                        <ul>
                            <li class="number"><a href="#"><?php the_field('numbercourses'); ?></a><a href="#"><?php the_field('bttellcourses'); ?></a></li>
                            <li><a href=""><?php the_field('adrescourses'); ?></a></li>
                    ...
                    <div class="block-content">
                        ...
                        <div class="title">
                            <p><?php the_field('titlefirstacad'); ?></p>
                        </div>
                        <div class="title-mobile">
                            <h1>Академия Barber’s</h1>
                            <p>Выездные обучающие семинары от Барберс - прокачайте свой коллектив.</p>
        ...
        <section class="description-academy">
            <div class="container">
                <div class="top-cont">
                    <h3><?php the_field('firsttitlecourses'); ?></h3>
                    <p><?php the_field('desfirsttitlecourses'); ?></p>
                </div>
                <div class="bt-cont">
                    <h3><?php the_field('secondtitlecourses'); ?></h3>
                    <div class="item-cont">
                        <div class="item">
                            <span><?php the_field('titlefirsttdcourses'); ?></span>
                            <h4><?php the_field('subtitlefirstcourses'); ?></h4>
                            <p><?php the_field('firstcolumndescourses'); ?></p>
                        </div>
                        <div class="item">
                            <span><?php the_field('titlesecondtdcourses'); ?></span>
                            <h4><?php the_field('subtitlesecondcourses'); ?></h4>
                            <p><?php the_field('secondcolumndescourses'); ?></p>
                        </div>
                        <div class="item">
                            <span><?php the_field('titlethirdtdcourses'); ?></span>
                            <h4><?php the_field('subtitlethirdcourses'); ?></h4>
                            <p><?php the_field('thirdcolumndescourses'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="algorithm">
            <div class="container">
                ...
                <div class="block-item">
                    <div class="item">
                        <div>
                            <img src="<?php the_field('rewfirstphotocourses'); ?>" alt="">
                            <h5><?php the_field('titilefirstphotocourses'); ?></h5>
                            <p><?php the_field('desfirstphotocourses'); ?></p>
                        </div>
                        <div>
                            <img src="<?php the_field('rewsecondphotocourses'); ?>" alt="">
                            <h5><?php the_field('titilesecondphotocourses'); ?></h5>
                            <p><?php the_field('dessecondphotocourses'); ?></p>
                        </div>
                    </div>
                    <div class="item">
                        <img src="<? echo get_template_directory_uri()?>/img/group.png" alt="">
                    </div>
                    <div class="item">
                        <div>
                            <img src="<?php the_field('rewthirdphotocourses'); ?>" alt="">
                            <h5><?php the_field('titilethirdphotocourses'); ?></h5>
                            <p><?php the_field('desthirdphotocourses'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="sign-up">
            ...
            <div class="sign-up-content">
                <h5 class=""><?php the_field('titleacadcourses'); ?></h5>
                <p class="courses-text"><?php the_field('desacadcourses'); ?></p>
        ...
        <section class="program">
            <div class="container">
                ...
                <div class="item-program">
                    <div class="images">
                        <img src="<?php the_field('photoprogramcourses'); ?>" alt="">
                    </div>
                    <div class="seminar-program">
                        <h4>В программу семинара входят</h4>
                        <ul>
                            <li><?php the_field('programfistcourses'); ?></li>
                            <li><?php the_field('programsecondcourses'); ?></li>
                            <li><?php the_field('programthirdcourses'); ?></li>
                            <li><?php the_field('programfourthcourses'); ?></li>
                            <li><?php the_field('programfifthcourses'); ?></li>
                            <li><?php the_field('programsixthcourses'); ?></li>
                        </ul>
                        <span>*Меняем программу с учетом Ваших пожеланий!</span>
                    </div>
                </div>
            </div>
        </section>
        <section class="teacher">
            <div class="container">
                ...
                <?php
                        ...
                        $slider_teacher = get_posts($args);
                        foreach ($slider_teacher as $post){
                            include( get_template_directory() . '/content_teacher_courses.php');
                        }
                        wp_reset_postdata();
                    ?>
                </div>
                ...
                <div class="block-cn">
                    <div class="item-contact">
                        <div class="contact">
                            ...
                            <span><?php the_field('adrescourses'); ?></span>
                            <a href=""><?php the_field('numbercourses'); ?></a>
                            <a href=""><?php the_field('bttellcourses'); ?></a>
                    ...
                    <div class="item-contact">
                        ...
                        <div class="app">
                            ...
                            <a href=""><img src="<? echo get_template_directory_uri()?>/img/google.jpg" alt=""></a>
                            <a href=""><img src="<? echo get_template_directory_uri()?>/img/apple.jpg" alt=""></a>
