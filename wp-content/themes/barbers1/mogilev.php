<?php
/**
 *Template Name: Шаблон могилева
 */
?>
<!doctype html>
<html <?php language_attributes(); ?>>
<head>
<title><?php bloginfo('barbers'); ?><?php wp_title('|Barbers Могилёв|Мужские парикмахерсккие'); ?></title>
	...
	<meta name="Keywords" content="Barbers,barbers могилёв,могилёв, барберс,парикмахерская,парикмахерские могилёв"> 
...
<body>
                ...
                <div class="top-content">
                    <div class="dropdown">
                        <button class="dropbtn">
                            Могилёв
                            <svg width="20" height="10" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                 x="0px" y="0px" viewBox="0 0 491.996 491.996"
                    ...
                    <ul>
                        <li class="number"><a href="tel:+375  (29)  510 - 50 - 10" itemprop="telephone"><?php the_field('toptellmogilev'); ?></a><a href="tel:+375  (29)  510 - 50 - 10" itemprop="telephone"><?php the_field('bttellmogilev'); ?></a></li>
                        <li><a href=""><?php the_field('adressmogilev'); ?></a></li>
	...
	<section class="second-block">
            <div class="container">
                ...
                <div class="about-us">
                    <div class="text">
                        <p><?php the_field('textaboutusmogilev'); ?></p>
                    </div>

                    <div class="photo">
                        <img src="<?php the_field('photoaboutusmogilev'); ?>" alt="Бритьё">
                    </div>
                </div>
                <div class="statistics">
                    <div class="item">
                        <h4><?php the_field('yearsmogilev'); ?></h4>
                        <span>лет на рынке</span>
                    </div>
                    <div class="item">
                        <h4><?php the_field('branchmogilev'); ?></h4>
                        <span>филиала</span>
                    </div>
                    <div class="item">
                        <h4><?php the_field('mastersmogilev'); ?></h4>
                        <span>мастера своего дела</span>
                    </div>
                    <div class="item">
                        <h4><?php the_field('clientmogilev'); ?></h4>
            ...
            <div class="container">
                ...
                <div class="prise-cont">
                    <div class="image-block">
                        <img src="<?php the_field('photomogilev'); ?>" alt="">
                    </div>
                    <div class="prise-block">
                        <div class="top-block">
                            ...
                            <ul>
                                <li>Мужская стрижка<span><?php the_field('menpricemogilev'); ?></span></li>
                                <li>Детская стрижка<span><?php the_field('childprisemogilev'); ?></span></li>
                                <li>Бритье головы<span><?php the_field('shavingheadmogilev'); ?></span></li>
                                <li>Укладка<span><?php the_field('stylingmogilev'); ?></span></li>
                                <li>Камуфляж седины<span><?php the_field('grayhairmogilev'); ?></span></li>
                            </ul>
                        </div>
                        <div class="bottom-block">
                            ...
                            <ul>
                                <li>Стрижка + борода<span><?php the_field('haircutbeardmogilev'); ?></span></li>
                                <li>Стрижка + гладкое бритье<span><?php the_field('haircutbeardglmogilev'); ?></span></li>
                                <li>Отец + сын<span><?php the_field('fathersonmogilev'); ?></span></li>
                                <li>Стрижка для студентов<span><?php the_field('studentsmogilev'); ?></span></li>
                            </ul>
                    ...
                    <div class="prise-block">
                        <div class="top-block">
                            ...
                            <ul>
                                <li>Стрижка бороды  <span><?php the_field('beardtrimmogilev'); ?></span></li>
                                <li>Бритьё  <span><?php the_field('shavingmogilev'); ?></span></li>
                                <li>Камуфляж бороды  <span><?php the_field('camouflagemogilev'); ?></span></li>
                                <li>Стрижка усов <span><?php the_field('mustachetrimmogilev'); ?></span></li>
                            </ul>
                        </div>
                        <div class="bottom-block">
                            <h5>
                            ...
                            <ul>
                                <li>Коррекция воском<span><?php the_field('correctionmogilev'); ?></span></li>
                            </ul>
                            <p>*стоимость стрижки может отличаться от класса мастера.</p>
                        </div>
                    </div>
                    <div class="image-block">
                        <img src="<?php the_field('photoprisebtmogilev'); ?>" alt="">
                    </div>
                </div>
            </div>
        </section>
        <section>
            ...
            <h2>Наши мастера</h2>
                ...
                <?php
                        global $post;
                        $args = array(
                            'post_type' => 'personmogilev',
                            'publish' => true
                        );
                        $slider_peronmogilev = get_posts($args);
                        foreach ($slider_peronmogilev as $post){
                            include( get_template_directory() . '/content_person_mogilev.php');
                        }
                        wp_reset_postdata();
                    ?>
                </div>
        ...
        <section class="certificate-block">
            ...
            <div class="sertif-content">
                <h5><?php the_field('titlemogilev'); ?></h5>
                <p><?php the_field('serdescriptmogilev'); ?></p>
            </div>
        </section>
        <?php $city = 'mogilev'; include 'content_reviewslider.php' ?>
            ...
            <div class="container">
                ...
                <div class="wrapper">
                    <div class="photo-person">
                        <img src="<?php the_field('barbertrainingmogilev'); ?>" alt="">
                    </div>
                    <div class="details">
        ...
        <section class="footer">
            <div class="map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d293.7842997486148!2d30.33325417902253!3d53.90909971505002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46d051dfd179241b%3A0x9670bb23c11a60be!2z0JHQsNGA0LHQtdGA0YjQvtC_IEJhcmJlcidTICjQkdCw0YDQsdC10YDRgSk!5e0!3m2!1sru!2sby!4v1596473186583!5m2!1sru!2sby" width="100%" height="350" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>
            <div class="bg-cl">
                ...
                <div class="block-cn">
                    <div class="contact">
                        ...
                        <span><?php the_field('adressmogilev'); ?></span>
                        <a href="tel:+375298367707"><?php the_field('toptellmogilev'); ?></a>
                        <a href="tel:+375296467707"><?php the_field('bttellmogilev'); ?></a>
                        <span class="time-work">ПН-ВС: 10:00-21:00</span>

                        <div class="social">
                            <div>
                                <a href="https://instagram.com/barbersmgl?igshid=oo4mk0qg05hc" target="_blank">
                            ...
                            <div>
                                <a href="https://vk.com/barbersmgl" target="_blank">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div>
                                <a href="viber://add?number=375298367701" href="viber://chat?number=+375298367701" target="_blank">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
