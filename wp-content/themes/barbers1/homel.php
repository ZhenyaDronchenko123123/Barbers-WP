<?php
/**
 *Template Name: Шаблон Гомеля
 */
?>
<!doctype html>
<html <?php language_attributes(); ?>>
<head>
    <title><?php bloginfo('barbers'); ?><?php wp_title('|Barbers Гомель|Мужские парикмахерсккие'); ?></title>
    ...
    <meta name="Keywords" content="Barbers,barbers гомель,гомель, барберс, парикмахерская, парикмахерские гомель"> 
...
<body>
            ...
            <div class="wrapper">
                <div class="content">
                    <div class="top-content">
                        <div class="dropdown">
                            <button class="dropbtn">
                                Гомель
                                <svg width="20" height="10" version="1.1"
                                     id="Layer_1"
                        ...
                        <ul>
                            <li class="number"><a href="tel:+375  (29)  510 - 50 - 10" itemprop="telephone"><?php the_field('toptellhomel'); ?></a><a href="tel:+375  (29)  510 - 50 - 10" itemprop="telephone"><?php the_field('bttellhomel'); ?></a></li>
                            <li><a href=""><?php the_field('adresshomel'); ?></a></li>
                            <li><span>ПН-ВС: 10:00-21:00</span></li>
                        </ul>
                        <div class="button-item">
                            <a href="https://n28956.yclients.com/company:64564/idx:0/master#1" target="_blank">Онлайн запись</a>
                    ...
                    <div class="block-content">
                        ...
                        <div class="title">
                            <h1><?php the_field('taglinehomel'); ?></h1>
                            <p><?php the_field('texthomel'); ?></p>
                        </div>
                        <a href="https://n28956.yclients.com/company:64564/idx:0/master#1" target="_blank">Онлайн запись</a>
                    </div>
                </div>
	    ...
	    <section class="second-block">
            <div class="container">
                ...
                <div class="about-us">
                    <div class="text">
                        <p><?php the_field('textaboutus'); ?></p>
                    </div>

                    <div class="photo">
                        <img src="<?php the_field('photoaboutushomel'); ?>" alt="Бритьё">
                    </div>
                </div>
                <div class="statistics">
                    <div class="item">
                        <h4><?php the_field('years'); ?></h4>
                        <span>лет на рынке</span>
                    </div>
                    <div class="item">
                        <h4><?php the_field('branch'); ?></h4>
                        <span>филиала</span>
                    </div>
                    <div class="item">
                        <h4><?php the_field('masters'); ?></h4>
            ...
            <div class="container">
                ...
                <div class="prise-cont">
                        <div class="image-block">
                            <img src="<?php the_field('photohomel'); ?>" alt="">
                        </div>
                        <div class="prise-block">
                            <div class="top-block">
                                ...
                                <ul>
                                    <li>Мужская стрижка<span><?php the_field('menpricehomel'); ?></span></li>
                                    <li>Детская стрижка<span><?php the_field('childprisehomel'); ?></span></li>
                                    <li>Бритье головы<span><?php the_field('shavingheadhomel'); ?></span></li>
                                    <li>Укладка<span><?php the_field('stylinghomel'); ?></span></li>
                                    <li>Камуфляж седины<span><?php the_field('grayhairhomel'); ?></span></li>
                                </ul>
                            </div>
                            <div class="bottom-block">
                                ...
                                <ul>
                                    <li>Стрижка + борода<span><?php the_field('haircutbeardhomel'); ?></span></li>
                                    <li>Стрижка + гладкое бритье<span><?php the_field('haircutbeardglhomel'); ?></span></li>
                                    <li>Отец + сын<span><?php the_field('fathersonhomel'); ?></span></li>
                                    <li>Стрижка для студентов<span><?php the_field('studentshomel'); ?></span></li>
                                </ul>
                        ...
                        <div class="prise-block">
                            <div class="top-block">
                                ...
                                <ul>
                                    <li>Стрижка бороды  <span><?php the_field('beardtrimhomel'); ?></span></li>
                                    <li>Бритьё  <span><?php the_field('shavinghomel'); ?></span></li>
                                    <li>Камуфляж бороды  <span><?php the_field('camouflagehomel'); ?></span></li>
                                    <li>Стрижка усов <span><?php the_field('mustachetrimhomel'); ?></span></li>
                                </ul>
                            </div>
                            <div class="bottom-block">
                                <h5>
                                ...
                                <ul>
                                    <li>Коррекция воском<span><?php the_field('correctionhomel'); ?></span></li>
                                </ul>
                                <p>*стоимость стрижки может отличаться от класса мастера.</p>
                            </div>
                        </div>
                        <div class="image-block">
                            <img src="<?php the_field('photoprisebthomel'); ?>" alt="">
                        </div>
                </div>
            </div>
        </section>
        <section>
            ...
            <h2>Наши мастера</h2>
                ...
                <?php
                        ...
                        $slider_peron = get_posts($args);
                        foreach ($slider_peron as $post){
                            include( get_template_directory() . '/content_person_homel.php');
                        }
                        wp_reset_postdata();
                    ?>
                </div>
        ...
        <section class="certificate-block">
            ...
            <div class="sertif-content">
                <h5><?php the_field('titlehomel'); ?></h5>
                <p><?php the_field('serdescripthomel'); ?></p>
            </div>
        </section>
        <?php $city = 'gomel'; include 'content_reviewslider.php' ?>
        <section class="sign-up">
            <div class="overlay"></div>
            <img src="<? echo get_template_directory_uri()?>/img/record.jpg" alt="">
            <div class="sign-up-content">
                <h5><?php the_field('titleblocktitlehomel'); ?></h5>
                <p><?php the_field('destithomel'); ?></p>
                <a href="https://n28956.yclients.com/company:64564/idx:0/master#1" target="_blank">Онлайн запись</a>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="wrapper">
                    <div class="photo-person">
                        <img src="<?php the_field('barbertraininghomel'); ?>" alt="">
                    </div>

                    <div class="details">
                        <p><?php the_field('learningdescriptionhomel'); ?></p>
            ...
            <div class="bg-cl">
                ...
                <div class="block-cn">
                    <div class="contact">
                        ...
                        <span><?php the_field('adresshomel'); ?></span>
                        <a href="tel:+375295105010"><?php the_field('toptellhomel'); ?></a>
                        <a href="tel:+375295105010"><?php the_field('bttellhomel'); ?></a>
                        <span class="time-work">ПН-ВС: 10:00-21:00</span>

                        <div class="social">
                            <div>
                                <a href="https://instagram.com/barbersgml?igshid=hircl7o20fdq" target="_blank">
                            ...
                            <div>
                                <a href="https://vk.com/barbersgml" target="_blank">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div>
                                <a href="viber://add?number=375295105010" href="viber://chat?number=+375295105010" target="_blank">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="app">
                        ...
                        <a class="online" href="https://n28956.yclients.com/company:64564/idx:0/master#1" target="_blank">Онлайн запись</a>
                    </div>
                </div>
            </div>
        </section>
